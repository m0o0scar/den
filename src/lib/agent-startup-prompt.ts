...
const DEV_SERVER_TESTING_INSTRUCTION =
  'For testing and debugging in web projects, start a fresh dev server before running checks. If you are not sure which dev server command or script to use, ask the user to provide the dev server script before proceeding.';
